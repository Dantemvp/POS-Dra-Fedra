-- ============================================================================
-- registrar_venta v2 — endurece dos cosas frente a la v1:
--   1) El precio NO se confía del cliente: se resuelve desde productos.precio_venta
--      (fuente única de verdad). El parámetro precio_unit del JSON se ignora.
--   2) La validación de stock se hace AGREGADA por producto: si el mismo
--      producto viene en varios renglones, se suma la cantidad total antes de
--      validar, evitando sobreventa.
-- Mantiene la firma para no romper el POS. Atómica, FIFO por caducidad.
-- ============================================================================

create or replace function public.registrar_venta(
  p_items jsonb,                 -- [{"producto_id":uuid,"cantidad":n, ...}]
