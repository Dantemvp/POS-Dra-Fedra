-- ============================================================================
-- RPC registrar_venta: registra una venta de forma ATÓMICA (una transacción).
-- Valida stock, crea venta + items, descuenta inventario por lote (FIFO por
-- caducidad), registra movimientos de salida y el pago. Si algo falla, todo
-- se revierte (integridad para dinero + inventario).
-- security invoker => corre con el rol del usuario (RLS aplica).
-- ============================================================================

create or replace function public.registrar_venta(
  p_items jsonb,                 -- [{"producto_id":uuid,"cantidad":n,"precio_unit":n}]
